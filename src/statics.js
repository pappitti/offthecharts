...
const scoringKeys=["FOULS","DOUBLES AND TRIPLES","NON DECISIVE ERRORS","POSSESSION",
             "DUELS","BIG CHANCE CREATED","ATTEMPTED ASSIST","PASSING","LONG PASSING",
             "SHOTS ON TARGET","WON CONTEST","PENALTY AREA ENTRIES","MISSED PENALTY",
             "MISSED CHANCE","INTERCEPTIONS","SAVE","CLAIMS","PUNCHES","DIVING","6SECONDS",
             "SMOOTHER","SWEEPER","GOALKEEPING","GOALS CONCEDED","DEFENDING",
             "ASSISTS","BLOCKS AND CLEARANCES","TACKLES","GENERAL","GOALS"];
...
export {decilesColors,indexColors,Categoryangles,profileRadarSizes,positions,pi,scoringMatrix, scoringKeys,scoringRadarKeys, DAradarkeys,AAradarkeys,statIndex,areaDetails}